...
// limit enforcement) DOES bundle correctly — proven by api/stripe-webhook.ts.
//
// The enforcement helpers below are duplicated between api/ocr.ts and
// api/gemini.ts because Vercel does not bundle shared helpers from api/_lib
// into deployed functions. Inline duplication is the proven-safe pattern.
